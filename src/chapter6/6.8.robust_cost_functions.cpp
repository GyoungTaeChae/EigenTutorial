...
int main() {
    std::cout << "=== 6.8 Robust Cost Functions ===\n\n";
    ...
    std::cout << "Residual |  Squared  |  Huber(1) |  Cauchy(1)\n";
    std::cout << "---------|-----------|-----------|------------\n";
    std::vector<double> test_residuals = {0.1, 0.5, 1.0, 2.0, 5.0, 10.0};
    ...
    std::cout << "This reduces the influence of outliers in optimization.\n";
