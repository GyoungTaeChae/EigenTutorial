...
int main() {
    std::cout << "=== 3.1 Rotation Matrix (SO3) ===\n\n";
    ...
    std::cout << "Rotation around Z-axis (45 deg):\n" << Rz << "\n\n";
    std::cout << "R^T * R (should be I):\n" << Rz.transpose() * Rz << "\n\n";
    std::cout << "R * R^T (should be I):\n" << Rz * Rz.transpose() << "\n\n";
    std::cout << "det(R) (should be 1): " << Rz.determinant() << "\n";
    return 0;
}
